...
export interface IbcPacketABI extends BaseContract {
  ...
  methods: {
    ...
    sendPacket(
      sourcePort: string,
      sourceChannel: string,
      timeoutHeight: [number | string | BN, number | string | BN],
