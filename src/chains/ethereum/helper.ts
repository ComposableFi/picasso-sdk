...
export const getContract = <T extends Contract>(web3: Web3, abi: AbiItem[] | AbiItem, contractAddress: string) => {
...
export const getBankContract = (web3: Web3) => {
	return getContract<Ics20BankABI & Contract>(web3, ics20BankABI as AbiItem[], bankContractAddress) as Ics20BankABI;
};
...
export const getErc20Contract = (web3: Web3, erc20TokenAddress: string) => {
	return getContract<Erc20ABI & Contract>(web3, erc20ABI as AbiItem[], erc20TokenAddress) as Erc20ABI;
};
