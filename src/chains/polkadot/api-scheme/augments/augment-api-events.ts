	...
	export interface AugmentedEvents<ApiType extends ApiTypes> {
		assetsRegistry: {
			AssetRegistered: AugmentedEvent<
				ApiType,
				[assetId: u128, location: ComposableTraitsXcmAssetsXcmAssetLocation, decimals: Option<u8>],
				{
					assetId: u128;
			...
			MinFeeUpdated: AugmentedEvent<
				ApiType,
				[targetParachainId: u32, foreignAssetId: ComposableTraitsXcmAssetsXcmAssetLocation, amount: Option<u128>],
				{
		...
		cosmwasm: {
			...
			AdminUpdated: AugmentedEvent<
				ApiType,
				[contract: AccountId32, oldAdmin: Option<AccountId32>, newAdmin: AccountId32],
				{
			...
			Emitted: AugmentedEvent<
				ApiType,
				[contract: AccountId32, ty: Bytes, attributes: Vec<ITuple<[Bytes, Bytes]>>],
				{
					contract: AccountId32;
					ty: Bytes;
			...
			Executed: AugmentedEvent<
				ApiType,
				[contract: AccountId32, entrypoint: PalletCosmwasmEntryPoint, data: Option<Bytes>],
				{
					contract: AccountId32;
			...
			ExecutionFailed: AugmentedEvent<
				ApiType,
				[contract: AccountId32, entrypoint: PalletCosmwasmEntryPoint, error: Bytes],
				{
					contract: AccountId32;
					entrypoint: PalletCosmwasmEntryPoint;
					error: Bytes;
		...
		crowdloanRewards: {
			...
			Claimed: AugmentedEvent<
				ApiType,
				[remoteAccount: PalletCrowdloanRewardsModelsRemoteAccount, rewardAccount: AccountId32, amount: u128],
				{
					remoteAccount: PalletCrowdloanRewardsModelsRemoteAccount;
					rewardAccount: AccountId32;
					amount: u128;
		...
		dexRouter: {
			...
			RouteUpdated: AugmentedEvent<
				ApiType,
				[xAssetId: u128, yAssetId: u128, oldRoute: Vec<u128>, updatedRoute: Vec<u128>],
				{
					xAssetId: u128;
					yAssetId: u128;
					oldRoute: Vec<u128>;
		...
		lending: {
			...
			MarketCreated: AugmentedEvent<
				ApiType,
				[marketId: u32, vaultId: u64, manager: AccountId32, currencyPair: ComposableTraitsDefiCurrencyPairCurrencyId],
				{
					marketId: u32;
					vaultId: u64;
					manager: AccountId32;
		...
		mosaic: {
			...
			AssetMappingCreated: AugmentedEvent<
				ApiType,
				[assetId: u128, networkId: u32, remoteAssetId: CommonMosaicRemoteAssetId],
				{
					assetId: u128;
					networkId: u32;
			...
			BudgetUpdated: AugmentedEvent<
				ApiType,
				[assetId: u128, amount: u128, decay: PalletMosaicDecayBudgetPenaltyDecayer],
				{
					assetId: u128;
					amount: u128;
		...
		pablo: {
			...
			LiquidityAdded: AugmentedEvent<
				ApiType,
				[who: AccountId32, poolId: u128, baseAmount: u128, quoteAmount: u128, mintedLp: u128],
				{
					who: AccountId32;
					poolId: u128;
					baseAmount: u128;
			...
			LiquidityRemoved: AugmentedEvent<
				ApiType,
				[who: AccountId32, poolId: u128, baseAmount: u128, quoteAmount: u128, totalIssuance: u128],
				{
					who: AccountId32;
					poolId: u128;
					baseAmount: u128;
			...
			PoolCreated: AugmentedEvent<
				ApiType,
				[poolId: u128, owner: AccountId32, assets: ComposableTraitsDefiCurrencyPairCurrencyId],
				{
					poolId: u128;
					owner: AccountId32;
		...
		proxy: {
			...
			ProxyAdded: AugmentedEvent<
				ApiType,
				[delegator: AccountId32, delegatee: AccountId32, proxyType: ComposableTraitsAccountProxyProxyType, delay: u32],
				{
		...
		stakingRewards: {
			...
			RewardTransferred: AugmentedEvent<
				ApiType,
				[from: AccountId32, poolId: u128, rewardCurrency: u128, rewardIncrement: u128],
				{
					from: AccountId32;
					poolId: u128;
					rewardCurrency: u128;
			...
			Unstaked: AugmentedEvent<
				ApiType,
				[owner: AccountId32, fnftCollectionId: u128, fnftInstanceId: u64, slash: Option<u128>],
				{
					owner: AccountId32;
					fnftCollectionId: u128;
					fnftInstanceId: u64;
			...
			UnstakeRewardSlashed: AugmentedEvent<
				ApiType,
				[poolId: u128, owner: AccountId32, fnftInstanceId: u64, rewardAssetId: u128, amountSlashed: u128],
				{
					poolId: u128;
					owner: AccountId32;
					fnftInstanceId: u64;
		...
		xTokens: {
			...
			TransferredMultiAssets: AugmentedEvent<
				ApiType,
				[sender: AccountId32, assets: XcmV1MultiassetMultiAssets, fee: XcmV1MultiAsset, dest: XcmV1MultiLocation],
				{
					sender: AccountId32;
