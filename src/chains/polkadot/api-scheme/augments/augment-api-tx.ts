	...
	export interface AugmentedSubmittables<ApiType extends ApiTypes> {
		...
		assetsRegistry: {
			...
			registerAsset: AugmentedSubmittable<
				(
					...
					ratio: ComposableTraitsCurrencyRational64 | { n?: any; d?: any } | string | Uint8Array,
					decimals: Option<u8> | null | Uint8Array | u8 | AnyNumber
				) => SubmittableExtrinsic<ApiType>,
				[ComposableTraitsXcmAssetsXcmAssetLocation, ComposableTraitsCurrencyRational64, Option<u8>]
			>;
			/**
			...
			updateAsset: AugmentedSubmittable<
				...
				[u128, ComposableTraitsXcmAssetsXcmAssetLocation, ComposableTraitsCurrencyRational64, Option<u8>]
			>;
			/**
			 * Generic tx
			 **/
		...
		cosmwasm: {
			...
			instantiate: AugmentedSubmittable<
				(
					codeIdentifier: PalletCosmwasmCodeIdentifier | { CodeId: any } | { CodeHash: any } | string | Uint8Array,
			...
			migrate: AugmentedSubmittable<
				(
					contract: AccountId32 | string | Uint8Array,
					newCodeIdentifier: PalletCosmwasmCodeIdentifier | { CodeId: any } | { CodeHash: any } | string | Uint8Array,
					gas: u64 | AnyNumber | Uint8Array,
					message: Bytes | string | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
		...
		crowdloanRewards: {
			...
			unlockRewardsFor: AugmentedSubmittable<
				(rewardAccounts: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>,
				[Vec<AccountId32>]
			>;
			/**
			 * Generic tx
		...
		currencyFactory: {
			...
			setMetadata: AugmentedSubmittable<
				(
					assetId: u128 | AnyNumber | Uint8Array,
					metadata: ComposableTraitsAssetsBasicAssetMetadata | { symbol?: any; name?: any } | string | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
		...
		dexRouter: {
			...
			buy: AugmentedSubmittable<
				(
					...
					outAsset: ComposableTraitsDexAssetAmount | { assetId?: any; amount?: any } | string | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
			...
			removeLiquidity: AugmentedSubmittable<
				(lpAmount: u128 | AnyNumber | Uint8Array, minReceive: BTreeMap<u128, u128>) => SubmittableExtrinsic<ApiType>,
			...
			swap: AugmentedSubmittable<
				(
					inAsset: ComposableTraitsDexAssetAmount | { assetId?: any; amount?: any } | string | Uint8Array,
					minReceive: ComposableTraitsDexAssetAmount | { assetId?: any; amount?: any } | string | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
			...
			updateRoute: AugmentedSubmittable<
				(
					...
					route: Option<Vec<u128>> | null | Uint8Array | Vec<u128> | (u128 | AnyNumber | Uint8Array)[]
				) => SubmittableExtrinsic<ApiType>,
		...
		farming: {
			deposit: AugmentedSubmittable<
				(poolCurrencyId: u128, amount: u128) => SubmittableExtrinsic<ApiType>,
				[u128, u128]
			>;
			claim: AugmentedSubmittable<
				(poolCurrencyId: u128, rewardCurrencyId: u128) => SubmittableExtrinsic<ApiType>,
				[u128, u128]
			>;
			withdraw: AugmentedSubmittable<
				...
				[u128, u128]
			>;
			updateRewardSchedule: AugmentedSubmittable<
				(poolCurrencyId: u128, currencyId: u128, periodCount: u128, amount: u128) => SubmittableExtrinsic<ApiType>,
				[u128, u128, u128, u128]
			>;
		};
		dutchAuction: {
		...
		ibc: {
			 ...
			 **/
			freezeClient: AugmentedSubmittable<
				(clientId: Bytes | string | Uint8Array, height: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[Bytes, u64]
			>;
			setParams: AugmentedSubmittable<
				(
					params: PalletIbcPalletParams | { sendEnabled?: any; receiveEnabled?: any } | string | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
				[PalletIbcPalletParams]
			>;
			transfer: AugmentedSubmittable<
				(
					params: PalletIbcTransferParams | { to?: any; sourceChannel?: any; timeout?: any } | string | Uint8Array,
					assetId: u128 | AnyNumber | Uint8Array,
					amount: u128 | AnyNumber | Uint8Array,
					memo?: Text
				) => SubmittableExtrinsic<ApiType>,
				[PalletIbcTransferParams, u128, u128, Option<Text>]
			>;
			/**
			 ...
			 **/
			upgradeClient: AugmentedSubmittable<
				(
					params: PalletIbcUpgradeParams | { clientState?: any; consensusState?: any } | string | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
				[PalletIbcUpgradeParams]
			>;
			/**
		...
		ibcPing: {
			sendPing: AugmentedSubmittable<
				(
					params:
						| PalletIbcPingSendPingParams
						| { data?: any; timeoutHeightOffset?: any; timeoutTimestampOffset?: any; channelId?: any }
						| string
						| Uint8Array
				) => SubmittableExtrinsic<ApiType>,
				[PalletIbcPingSendPingParams]
		...
		palletLiquidStaking: {
			...
			unstake: AugmentedSubmittable<
				(
					liquidAmount: u128 | AnyNumber | Uint8Array,
					unstakeProvider:
						| Codec
						| PalletLiquidStakingUnstakeProvider
						| 'RelayChain'
		...
		pablo: {
			...
			create: AugmentedSubmittable<
				(
					pool: PalletPabloPoolInitConfiguration | { DualAssetConstantProduct: any } | string | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
			...
			swap: AugmentedSubmittable<
				...
				[u128, ComposableTraitsDexAssetAmount, ComposableTraitsDexAssetAmount, bool]
			>;
			/**
			 * Generic tx
			 **/
		...
		proxy: {
			...
			addProxy: AugmentedSubmittable<
				(
					...
					proxyType: ComposableTraitsAccountProxyProxyType | 'Any' | 'Governance' | 'CancelProxy' | number | Uint8Array,
					delay: u32 | AnyNumber | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
			...
			killAnonymous: AugmentedSubmittable<
				...
				[AccountId32, ComposableTraitsAccountProxyProxyType, u16, Compact<u32>, Compact<u32>]
			>;
			/**
			...
			proxyAnnounced: AugmentedSubmittable<
				...
				[AccountId32, AccountId32, Option<ComposableTraitsAccountProxyProxyType>, Call]
			>;
			/**
		...
		vault: {
			...
			claimSurcharge: AugmentedSubmittable<
				(
					...
					address: Option<AccountId32> | null | Uint8Array | AccountId32 | string
				) => SubmittableExtrinsic<ApiType>,
		...
		vesting: {
			...
			vestedTransfer: AugmentedSubmittable<
				...
				[MultiAddress, MultiAddress, u128, ComposableTraitsVestingVestingScheduleInfo]
			>;
			/**
			 * Generic tx
			 **/
