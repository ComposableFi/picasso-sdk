...
declare module '@polkadot/rpc-core/types/jsonrpc' {
	export interface RpcInterface {
		...
		contracts: {
			...
			>;
			/**
			 * @deprecated Not available in newer versions of the contracts interfaces.ts
      ...
      isFlatFee: AugmentedRpc<(assetId: AssetId | string) => Observable<SafeRpcWrapper<Balance>>>,
		...
		reward: {
			estimateFarmingReward: AugmentedRpc<
				(
					accountId: AccountId,
					poolCurrencyId: Text,
			...
			>;
			computeFarmingReward: AugmentedRpc<
				(
					accountId: AccountId,
					poolCurrencyId: Text,
					rewardCurrencyId: Text,
		...
		ibc: {
			queryBalanceWithAddress: AugmentedRpc<
				(
					addr: AccountId32,
					assetId: CurrencyId
				) => Observable<BTreeMap<SafeRpcWrapper<AssetId>, SafeRpcWrapper<Balance>>>
			>;
			queryPacketAcknowledgement: AugmentedRpc<
				(
					chainId: Vec<u8>,
					portId: Vec<u8>,
					seq: u64
