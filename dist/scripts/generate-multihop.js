...
var fs = require('fs');
var multihopRouteFilePath = path_1.default.join(__dirname, '../config/multihopRoute.ts');
var fetchMultihopPaths = function () { return __awaiter(void 0, void 0, void 0, function () {
    var polkadotComposable, kusamaPicasso, result, multihopOutputContent, error_1;
