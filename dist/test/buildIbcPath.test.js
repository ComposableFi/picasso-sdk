...
var helper_1 = require("../chains/polkadot/helper");
...
(0, globals_1.describe)('getNetworkFromAddress', function () {
    (0, globals_1.test)('should correctly detect Solana address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(solanaAddress)).toBe('solana');
    });
    (0, globals_1.test)('should correctly detect Picasso bech32 address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(picassoAddress)).toBe('centauri-1');
    });
    (0, globals_1.test)('should correctly detect Osmosis bech32 address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(osmosisAddress)).toBe('osmosis-1');
    });
    (0, globals_1.test)('should correctly detect Ethereum address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(ethereumAddress)).toBe('ethereum');
    });
    (0, globals_1.test)('should correctly detect Picasso SS58 address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(picassoSS58Address)).toBe('2087');
    });
});
(0, globals_1.describe)('getNetworkFromAddress', function () {
    (0, globals_1.test)('should correctly detect Picasso kusama address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(picassoKusamaAddress)).toBe('2087');
    });
    (0, globals_1.test)('should correctly detect Astar address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(astarAddress)).toBe('2006');
    });
    (0, globals_1.test)('should correctly detect Solana address', function () {
        var solanaAddress = '1ryziZbFQW4fcWck9wW4vU4KD4qxPHKhmAht6pXPFWo';
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(solanaAddress)).toBe('solana');
    ...
    (0, globals_1.test)('should correctly detect error address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(solanaAddress)).toBe('');
    });
    (0, globals_1.test)('should correctly detect Ethereum address', function () {
    ...
    (0, globals_1.test)('should correctly detect Picasso cosmos address', function () {
        ...
        (0, globals_1.expect)((0, helper_1.getNetworkFromAddress)(picassoCosmosAddress)).toBe('centauri-1');
    });
});
