...
exports.simulate =
  exports.getApprovedErc20 =
  exports.getErc20Contract =
  exports.isEthereumAddress =
  exports.getEthSimulate =
  exports.getTransactionReceipt =
  exports.getEthGasAmount =
  exports.getGasPrice =
  exports.getBlock =
  exports.getConsole =
  exports.getBankContract =
  exports.getBankTransferContract =
  exports.getContract =
  exports.getWeb3 =
    void 0;
...
var getWeb3 = function (endpoint) {
  return new web3_1.default(
    new web3_1.default.providers.HttpProvider(endpoint)
  );
};
...
var getBankTransferContract = function (web3) {
  return (0, exports.getContract)(
    web3,
    abi_1.ics20TransferBankABI,
    constants_1.bankTransferContractAddress
  );
};
...
var getBankContract = function (web3) {
  return (0, exports.getContract)(
    web3,
    abi_1.ics20BankABI,
    constants_1.bankContractAddress
  );
};
...
var getBlock = function (web3_2) {
  ...
  return __awaiter(
    void 0,
    __spreadArray([web3_2], __read(args_1), false),
    void 0,
    function (web3, addedAmount) {
      if (addedAmount === void 0) {
        addedAmount = 10000;
      }
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!web3) return [2 /*return*/, '0'];
            return [4 /*yield*/, web3.eth.getBlockNumber()];
          case 1:
            return [2 /*return*/, _a.sent() + addedAmount];
        }
      });
    }
  );
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            2 /*return*/,
            new big_js_1.default(gasPrice || 0).mul(1.3).toFixed(0),
          ];
      }
    });
  });
...
var getEthGasAmount = function (web3, txConfig) {
  return __awaiter(void 0, void 0, void 0, function () {
    var gasAmount, err_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
var getTransactionReceipt = function (web3, txHash) {
  return __awaiter(void 0, void 0, void 0, function () {
    var receipt;
    return __generator(this, function (_a) {
      if (!web3) return [2 /*return*/, ''];
...
var getEthSimulate = function (web3, data, txObject) {
  web3.eth
    ...
    .then(function (result) {
      return console.log(result, 'simulatedresult');
    })
    .catch(function (err) {
      return console.error(err, 'simulated??');
    });
};
...
var getApprovedErc20 = function (web3_2, account_1, erc20TokenAddress_1) {
  ...
  return __awaiter(
    void 0,
    __spreadArray(
      [web3_2, account_1, erc20TokenAddress_1],
      __read(args_1),
      false
    ),
    void 0,
    function (web3, account, erc20TokenAddress, spenderContract) {
      var erc20Contract;
      if (spenderContract === void 0) {
        spenderContract = constants_1.bankContractAddress;
      }
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!(0, exports.isEthereumAddress)(web3, account))
              return [2 /*return*/, '0'];
            erc20Contract = (0, exports.getErc20Contract)(
              web3,
              erc20TokenAddress
            );
            if (!erc20Contract) return [2 /*return*/, '0'];
            return [
              4 /*yield*/,
              erc20Contract.methods.allowance(account, spenderContract).call(),
            ];
          case 1:
