...
export declare const getContract: <T extends Contract>(
  web3: Web3,
  abi: AbiItem[] | AbiItem,
  contractAddress: string
) => T;
export declare const getBankTransferContract: (
  web3: Web3
...
export declare const getEthGasAmount: (
  web3: Web3,
...
export declare const getTransactionReceipt: (
  web3: Web3,
  txHash: string
) => Promise<'' | import('web3-eth').TransactionReceipt>;
export declare const getEthSimulate: (
  web3: Web3,
  data: string,
  txObject: any
) => void;
export declare const isEthereumAddress: (
  web3: Web3,
  account: string
) => boolean;
...
export declare const getApprovedErc20: (
  web3: Web3,
  account: string,
  erc20TokenAddress: string,
  spenderContract?: string
) => Promise<string>;
export declare const simulate: (
  web3: Web3,
  data: string,
  txObject: any
) => void;
